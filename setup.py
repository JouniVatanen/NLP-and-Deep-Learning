...
DESCRIPTION = metadata.get('description', 'Natural language processing and deep learning course from Udemy. See more info in README.md.')
AUTHOR = metadata.get('author', 'Jouni Vatanen')
AUTHOR_EMAIL = metadata.get('author_email', 'jounipvatanen@gmail.com')
